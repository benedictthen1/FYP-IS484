...
def init_dashboard(server):
    ...
    cdf = pd.read_csv('TestDataManipulatedAllCols.csv')
    ...
    dash_table.DataTable(
        ...
        style_table={'overflowY': 'auto','height': '345px',"width": '620px'},
        style_data={'maxWidth': '75px','minWidth': '75px'},
    ...
    dash_app.callback(Output("fin_modal", "is_open"),
    ...
    dash_app.callback(Output("client_modal", "is_open"),
...
#Ticker Banner Metrics
    ...
    @dash_app.callback([Output("client_coy_table", "data"),Output("client_coy_table","columns")],
                [Input("search-button","n_clicks"),Input("coy_table","selected_cells"),Input("coy_table","derived_virtual_data")],
                [State("input","value")])
    ...
    #Stats Stock Table 
    @dash_app.callback([Output("stats_table", "columns"),Output("stats_table", "data"),Output("coy_desc","children")],
                [Input("search-button","n_clicks"),Input("coy_table","selected_cells"),Input("coy_table","derived_virtual_data")],
                [State("input","value")])
    ...
    @dash_app.callback([Output("candle","figure"),Output("coy_name","children"),Output("close_price","children"),Output("price_diff","children"),Output("price_date","children")],
    ...
    #Cashflow Bar Chart
    @dash_app.callback(Output("cashflow_bar", "figure"),
                [Input("search-button","n_clicks"),Input("coy_table","selected_cells"),Input("coy_table","derived_virtual_data")],
                [State("input","value")])
    ...
    #Balance Sheet Bar
    @dash_app.callback(Output("balance_chart", "figure"),
                [Input("search-button","n_clicks"),Input("coy_table","selected_cells"),Input("coy_table","derived_virtual_data")],
                [State("input","value")])
    ...
    @dash_app.callback(Output("income_chart", "figure"),
                [Input("search-button","n_clicks"),Input("coy_table","selected_cells"),Input("coy_table","derived_virtual_data")],
                [State("input","value")])
    ...
    @dash_app.callback(Output('client_name_dropdown','value'),
                [Input("client_table","selected_cells"),Input("client_table","derived_virtual_data")])
    def link(t1,t2):
        if t1:
            row_num = t1[0]["row"]
    ...
    def overall_section(selected_base_numbers):
        ...
        pie_chart_fig = px.pie(latest_piechart_data, values='Nominal Amount (USD)', names='Asset Class',
                                title="Current Client's Asset & Liabilities Breakdown",
