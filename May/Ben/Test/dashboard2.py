...
def init_dashboard2(server):
    ...
    @dash_app.callback(Output("testingz", "children"),
    ...
    @dash_app.callback(Output("sidebar", "className"),[Input("sidebar-toggle", "n_clicks")],[State("sidebar", "className")])
    def toggle_classname(n, classname):
        if n and classname == "":
            return "collapsed"
        return ""

    @dash_app.callback(Output("collapse", "is_open"),[Input("navbar-toggle", "n_clicks")],[State("collapse", "is_open")])
    ...
    @dash_app.callback(Output("client_checkbox", "value"),
    ...
    @dash_app.callback(Output("asset_checkbox", "value"),
    ...
    @dash_app.callback([Output("base_checkbox","options"),Output("base_checkbox","value")],
    ...
    @dash_app.callback([Output("sub_asset_checkbox","options"),Output("sub_asset_checkbox","value")],
    ...
    @dash_app.callback(Output("ccy_checkbox", "value"),
    ...
    @dash_app.callback(Output("main_table","columns"),
