...
from starlette.middleware.wsgi import WSGIMiddleware # added
from flask_app import app as flask_app # added
from sample_dash import app as dash_app # added
...
app.mount("/flask", WSGIMiddleware(flask_app.wsgi_app)) # added
app.mount("/dash", WSGIMiddleware(dash_app.server)) # added
