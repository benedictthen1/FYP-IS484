...
def return_values_for_whatsapp_msg():
...
poorly_performing_client_count,out_of_target_client_no,no_of_clients_due_in_1y,no_of_clients_overdue = return_values_for_whatsapp_msg()
morning_msg_text = return_morning_msg_text(poorly_performing_client_count,out_of_target_client_no,no_of_clients_due_in_1y)
send_whatsapp_message(morning_msg_text)